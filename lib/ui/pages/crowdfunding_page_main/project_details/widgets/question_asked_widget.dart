    ...
    return cubit.state.questionsData.isNotEmpty
      ...
      children: List.generate(
          cubit.state.questionsData.length,
              (index) {
            var name = cubit.state.questionsData[index].user!.firstName!;
            var lastname = cubit.state.questionsData[index].user!.lastName!;
            return Container(
                      ...
                      cubit.state.questionsData[index].answers!.length,
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              AppWidgets.text(
                                text: cubit.state.questionsData[index].answers![i].content??"",
                                fontWeight: FontWeight.w400,
                                fontSize: 14.sp,
                                color: AppColorUtils.TEXT_GREY2,
                                maxLines: 100,
