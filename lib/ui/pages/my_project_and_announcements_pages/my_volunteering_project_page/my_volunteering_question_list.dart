...
class MyVolunteeringQuestionList extends StatefulWidget {
  MyVolunteeringQuestionList({required this.cardModel, Key? key}) : super(key: key);
  final VolunteeringModel cardModel;
  @override
  _MyVolunteeringQuestionListState createState() => _MyVolunteeringQuestionListState();
}
bool isVisible=true;

class _MyVolunteeringQuestionListState extends State<MyVolunteeringQuestionList> {
  @override
              ...
              Visibility(
                ...
                child: Container(
                  ...
                  child: InkWell(
                    ...
                    ).paddingOnly(left: 10.w, top: 7.w, bottom: 10.w, right: 15.w,),
                  ),
