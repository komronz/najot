...
class MyCrowdfundingQuestionList extends StatefulWidget {
  MyCrowdfundingQuestionList({required this.cardModel, Key? key}) : super(key: key);
  final KraufandingModel cardModel;

  @override
  _MyCrowdfundingQuestionListState createState() => _MyCrowdfundingQuestionListState();
}
bool isVisible=true;

class _MyCrowdfundingQuestionListState extends State<MyCrowdfundingQuestionList> {
  @override
