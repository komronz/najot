...
Widget singleTabDetail(bool type, String text){
  return GestureDetector(
    ...
    child: Container(
      ...
      child: Text(text,style: TextStyle(fontSize: 14.sp, color: type?Color(0xFF048D6A):Color(0xFF939598),
  ...
  return Column(
    ...
    children: [
      Container(
        ...
        child: Text(title,style: TextStyle(fontSize: 17.sp, color: Color(0xFF414042),
            fontWeight: FontWeight.w600),
        ),
      ),
      SizedBox(height: 6.h),
      Container(
        child: Text(text,style: TextStyle(fontSize: 14.sp, color: Color(0xFF58595B),
