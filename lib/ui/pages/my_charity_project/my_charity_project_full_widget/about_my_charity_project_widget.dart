...
class AboutMyCharityProjectWidget extends StatefulWidget {
  ...
  @override
  _AboutMyCharityProjectWidgetState createState() => _AboutMyCharityProjectWidgetState();
}

class _AboutMyCharityProjectWidgetState extends State<AboutMyCharityProjectWidget>
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  MyCharityPriceWidget(model: widget.model).paddingOnly(top: 18.w),
                  Row(
