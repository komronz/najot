      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            ).paddingOnly(top: 15,right: 20,left: 20,),
            Divider(
              thickness: 2,
            ).paddingOnly(bottom: 8,right: 20,left: 20,),
            if (!list.isEmpty) SingleChildScrollView(
                    child: Container(
                      height: 555.w,
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              flex: 3,
              child: AppWidgets.text(text: "+${'10 000 000'} so'm",
