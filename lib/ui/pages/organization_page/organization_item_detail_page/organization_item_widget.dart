...
class OrganizationItemWidget extends StatefulWidget {
  ...
  static const String routName = 'OrganizationItemWidget';
  static int tabChange = 0;
  OrganizationItemModel model;

  @override
  State<OrganizationItemWidget> createState() => _OrganizationItemWidgetState();
}

class _OrganizationItemWidgetState extends State<OrganizationItemWidget>
