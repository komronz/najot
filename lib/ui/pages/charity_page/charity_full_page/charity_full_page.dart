...
import 'package:najot/data/bloc/charity_full_page_cubit/charity_full_cubit.dart';
...
class _CharityFullPageState extends State<CharityFullPage>
  ...
  CharityFullCubit cubit = CharityFullCubit();
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: BlocBuilder<CharityFullCubit, CharityFullState>(
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                       ...
                       widget.cardModel.progres !=null
                           ? DetailBodyPart2(cardModel: widget.cardModel)
                           : DetailBodyPart1(cardModel: widget.cardModel)
                      ],
                    ),
                  ),
                  SizedBox(
