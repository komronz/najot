...
class VolunteerHelpWidget extends StatelessWidget {
  ...
  VolunteerHelpWidget({required this.cardModel});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: BlocProvider(
          ...
          child: BlocBuilder<VolonteerDetailCubit, VolunteerDetailState>(
                  ...
                  ButtonCard(
                    onPress: () {
                      if (state.checkBox) {
                        showDialog(
                            context: context,
                            builder: (ctx) => CustomTimePickerDialog(
